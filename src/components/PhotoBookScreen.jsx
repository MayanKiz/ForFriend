                            ...
                            >
                                ...
                                >
                                    <div className="absolute inset-6 border-2 border-cyan-400/30 rounded-lg flex flex-col items-center justify-center text-white">
                                        ...
                                        <h3 className="text-2xl font-bold mb-2 text-center">Welcome to your surprise</h3>
                                        <h3 className="text-2xl font-bold mb-4 text-center">Welcome to your surprise</h3>
